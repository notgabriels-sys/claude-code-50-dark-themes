...
- Document contents and embedded audio metadata are not parsed in version 0.1.0.
...
- The app and CLI expose three built-in presets only: General Audio, Stereo Premaster, and Digital Release.
- The core can resolve programmatic custom preset definitions, but version 0.1.0 has no custom-preset editor or file-import command.
