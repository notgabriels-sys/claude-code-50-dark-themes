...
print -- "Developer-ID-unsigned release packaging: real binaries, selected icon, ad-hoc signatures, architecture, provenance, sample scan, archive paths, and SHA-256 verified."
