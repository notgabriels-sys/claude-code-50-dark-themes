...
- **[The palettes in Apple Mail](mail/)** — Mail has no theming API, so this is the honest maximum: the five settings that do take a color or a font, wired to the theme keys, plus a signature that survives the recipient's client.
